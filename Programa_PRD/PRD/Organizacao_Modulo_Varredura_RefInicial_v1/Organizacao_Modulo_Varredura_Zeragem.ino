...
void writeNFC(){
    ...
    if (nfc.tagPresent()) {
        ...
        message.addUriRecord("(:init(pos 1x1),(on t4))");
...
bool varredura(){
   ...
   while ( (3 > contBlocos < 5 ) && (contPosicoes < 25)){
      ...
      if (temBloco == "A" || temBloco == "B" || temBloco == "C" || temBloco == "D" || temBloco == "E"){
        ...
        } else if ( ((posicaoAtual - posicaoPassada) == 5) && (posicaoAtual < 6) ){
          posicaoPassada = posicaoAtual;
          posicoes(posicaoAtual - 4);
        } else if (((posicaoAtual - posicaoPassada) == 5) && (posicaoAtual < 11)){
          posicaoPassada = posicaoAtual;
          posicoes(posicaoAtual - 9);
        }else if (((posicaoAtual - posicaoPassada) == 5) && (posicaoAtual < 16)){
          posicaoPassada = posicaoAtual;
          posicoes(posicaoAtual - 14);
        }else if (((posicaoAtual - posicaoPassada) == 5) && (posicaoAtual < 21)){
          posicaoPassada = posicaoAtual;
