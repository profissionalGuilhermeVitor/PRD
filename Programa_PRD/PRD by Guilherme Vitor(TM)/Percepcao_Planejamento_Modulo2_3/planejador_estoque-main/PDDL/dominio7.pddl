(define (domain New_Project_1)
    ...
    (:action moverPiso5
     :parameters (?prod - produto5 ?l1 - lugar ?l2 - lugar ?l3 - lugar)
     :precondition
       (and
         (plivre5 ?prod)
         (livre ?l1)
    ...
    (:action moverPiso7
     :parameters (?prod - produto7 ?l1 - lugar ?l2 - lugar ?l3 - lugar)
     :precondition
       (and
         (plivre7 ?prod)
         (livre ?l1)
    ...
    (:action empilhar5
     :parameters (?prod - produto5 ?l1 - lugar ?l2 - lugar ?l3 - lugar ?l4 - lugar ?l5 - lugar ?l6 - lugar)
     :precondition
       (and
         (plivre5 ?prod)
         (not (livre ?l1))
