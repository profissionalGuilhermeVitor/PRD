(define (domain New_Project_1)
    ...
    (:action moverPiso1
     :parameters (?prod - produto1 ?l1 - lugar ?l2 - lugar ?l3 - lugar ?l4 - lugar)
     :precondition
       (and
         (plivre1 ?prod)
         (livre ?l1)
    ...
    (:action moverPiso5
     :parameters (?prod - produto5 ?l1 - lugar ?l2 - lugar)
     :precondition
       (and
         (plivre5 ?prod)
         (livre ?l1)
    ...
    (:action moverPiso6
     :parameters (?prod - produto6 ?l1 - lugar ?l2 - lugar)
     :precondition
       (and
         (plivre6 ?prod)
         (livre ?l1)
    ...
    (:action moverPiso7
     :parameters (?prod - produto7 ?l1 - lugar)
     :precondition
       (and
         (plivre7 ?prod)
         (livre ?l1)
    ...
    (:action empilhar1
     :parameters (?prod - produto1 ?l1 - lugar ?l2 - lugar ?l3 - lugar ?l4 - lugar ?l5 - lugar ?l6 - lugar ?l7 - lugar ?l8 - lugar)
     :precondition
       (and
         (plivre1 ?prod)
         (not (livre ?l1))
    ...
    (:action empilhar2
     :parameters (?prod - produto2 ?l1 - lugar ?l2 - lugar ?l3 - lugar ?l4 - lugar ?l5 - lugar ?l6 - lugar)
     :precondition
       (and
         (plivre2 ?prod)
         (not (livre ?l1))
    ...
    (:action empilhar3
     :parameters (?prod - produto3 ?l1 - lugar ?l2 - lugar ?l3 - lugar ?l4 - lugar ?l5 - lugar ?l6 - lugar)
     :precondition
       (and
         (plivre3 ?prod)
         (not (livre ?l1))
    ...
    (:action empilhar4
     :parameters (?prod - produto4 ?l1 - lugar ?l2 - lugar ?l3 - lugar ?l4 - lugar)
     :precondition
       (and
         (plivre4 ?prod)
         (not (livre ?l1))
    ...
    (:action empilhar6
     :parameters (?prod - produto6 ?l1 - lugar ?l2 - lugar ?l3 - lugar)
     :precondition
       (and
         (plivre6 ?prod)
         (not (livre ?l1))
    ...
    (:action empilhar7
     :parameters (?prod - produto7 ?l1 - lugar ?l2 - lugar)
     :precondition
       (and
         (plivre7 ?prod)
         (not (livre ?l1))
